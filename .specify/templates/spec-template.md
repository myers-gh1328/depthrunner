...
- **CM-001 (Frame Pacing)**: [e.g., "Maintain smooth 60fps for >95% of active gameplay time on target devices"]
- **CM-002 (Readability Accuracy)**: [e.g., "At least 90% of test players correctly identify each new entity on first exposure"]
- **CM-003 (Input Completeness)**: [e.g., "All core actions are executable via keyboard and touch in the same gameplay flow"]
- **CM-004 (Audio Independence)**: [e.g., "All acceptance scenarios pass with audio disabled or blocked"]
